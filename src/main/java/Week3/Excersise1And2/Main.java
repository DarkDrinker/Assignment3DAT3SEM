...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Unicorn UnicornAnderssss = new Unicorn();
        UnicornAnderssss.setName("Anderssss");
        UnicornAnderssss.setAge(10);
        UnicornAnderssss.setPowerStrength(100);
        ...
        Unicorn createdUnicorn = unicornDAO.save(UnicornAnderssss);
