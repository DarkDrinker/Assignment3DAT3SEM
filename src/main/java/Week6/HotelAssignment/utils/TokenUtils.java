package Week6.HotelAssignment.utils;

import Week6.HotelAssignment.DTO.UserDTO;
import Week6.HotelAssignment.Exceptions.ApiException;
import Week6.HotelAssignment.Exceptions.NotAuthorizedException;
...
public class TokenUtils {
    ...
    //CHECKS IF DEPLOYED
    public String createToken(UserDTO user, String ISSUER, String TOKEN_EXPIRE_TIME, String SECRET_KEY) throws ApiException {
